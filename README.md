...
La interfaz fue desarrollada con HTML, CSS y Bootstrap, mientras que JavaScript se encarga de la generación dinámica del torneo, manipulación del DOM, gestión de resultados, cálculo de posiciones y persistencia de datos.

Tecnologías utilizadas: HTML - CSS - Bootstrap - JavaScript 
